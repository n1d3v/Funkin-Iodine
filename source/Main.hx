...
class Main extends Sprite
{
  ...
  #if web
  var framerate:Int = 120; // How many frames per second the game should run at. Also the web has some sort of VSync? idk fuck chrome
  #else
  ...
  function setupGame():Void
  {
    ...
    fpsCounter = new FPS(14, 3, 0xFFFFFF);

    #if !html5
    // addChild gets called by the user settings code.
    // TODO: disabled on HTML5 (todo: find another method that works?)
    memoryCounter = new MemoryCounter(14, 13, 0xFFFFFF);
    #end
