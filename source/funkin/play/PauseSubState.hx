...
class PauseSubState extends MusicBeatSubState
{
  ...
  function buildMetadata():Void
  {
    ...
    metadataSong.setFormat(Paths.font('psm.ttf'), 32, FlxColor.WHITE, FlxTextAlign.RIGHT);
    ...
    metadataArtist.setFormat(Paths.font('psm.ttf'), 32, FlxColor.WHITE, FlxTextAlign.RIGHT);
    if (PlayState.instance?.currentChart != null)
    {
    ...
    metadataDifficulty.setFormat(Paths.font('psm.ttf'), 32, FlxColor.WHITE, FlxTextAlign.RIGHT);
    ...
    metadataDeaths.setFormat(Paths.font('psm.ttf'), 32, FlxColor.WHITE, FlxTextAlign.RIGHT);
    metadataDeaths.scrollFactor.set(0, 0);
    metadata.add(metadataDeaths);

    metadataPractice = new FlxText(20, metadataDeaths.y + 32, FlxG.width - 40, 'PRACTICE MODE');
    metadataPractice.setFormat(Paths.font('psm.ttf'), 32, FlxColor.WHITE, FlxTextAlign.RIGHT);
